...
_sage_const_3 = Integer(3); _sage_const_134 = Integer(134); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_210 = Integer(210); _sage_const_6 = Integer(6); _sage_const_5 = Integer(5); _sage_const_2 = Integer(2); _sage_const_247 = Integer(247); _sage_const_9 = Integer(9); _sage_const_4 = Integer(4); _sage_const_8 = Integer(8); _sage_const_240 = Integer(240); _sage_const_11 = Integer(11); _sage_const_213 = Integer(213); _sage_const_10 = Integer(10); _sage_const_15 = Integer(15); _sage_const_257 = Integer(257); _sage_const_7 = Integer(7); _sage_const_230 = Integer(230); _sage_const_223 = Integer(223)## This file (subgroupOfComplexNumbers.sagetex.sage) was *autogenerated* from subgroupOfComplexNumbers.tex with sagetex.sty version 2019/01/09 v3.2.
import sagetex
