...
_sage_const_43 = Integer(43); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_3 = Integer(3); _sage_const_7 = Integer(7); _sage_const_4 = Integer(4); _sage_const_0 = Integer(0); _sage_const_145 = Integer(145); _sage_const_151 = Integer(151); _sage_const_153 = Integer(153); _sage_const_155 = Integer(155); _sage_const_165 = Integer(165); _sage_const_5 = Integer(5); _sage_const_167 = Integer(167); _sage_const_6 = Integer(6); _sage_const_178 = Integer(178); _sage_const_8 = Integer(8)## This file (solveRadicalLeadQuadraticEquation.sagetex.sage) was *autogenerated* from solveRadicalLeadQuadraticEquation.tex with sagetex.sty version 2019/11/14 v3.4.
import sagetex
_st_ = sagetex.SageTeXProcessor('solveRadicalLeadQuadraticEquation', version='2019/11/14 v3.4', version_check=True)
