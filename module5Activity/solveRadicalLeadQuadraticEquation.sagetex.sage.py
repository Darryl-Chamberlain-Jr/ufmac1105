...
_sage_const_3 = Integer(3); _sage_const_41 = Integer(41); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_7 = Integer(7); _sage_const_6 = Integer(6); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_165 = Integer(165); _sage_const_8 = Integer(8); _sage_const_163 = Integer(163); _sage_const_153 = Integer(153); _sage_const_176 = Integer(176); _sage_const_151 = Integer(151); _sage_const_143 = Integer(143); _sage_const_149 = Integer(149); _sage_const_2 = Integer(2)## This file (solveRadicalLeadQuadraticEquation.sagetex.sage) was *autogenerated* from solveRadicalLeadQuadraticEquation.tex with sagetex.sty version 2015/08/26 v3.0-92d9f7a.
import sagetex
