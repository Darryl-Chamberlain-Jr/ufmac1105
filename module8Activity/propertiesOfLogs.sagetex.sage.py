...
_sage_const_42 = Integer(42); _sage_const_3 = Integer(3); _sage_const_9 = Integer(9); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_60 = Integer(60); _sage_const_66 = Integer(66); _sage_const_0 = Integer(0); _sage_const_68 = Integer(68); _sage_const_78 = Integer(78); _sage_const_4 = Integer(4); _sage_const_80 = Integer(80); _sage_const_5 = Integer(5); _sage_const_86 = Integer(86); _sage_const_10 = Integer(10); _sage_const_94 = Integer(94); _sage_const_102 = Integer(102); _sage_const_6 = Integer(6); _sage_const_7 = Integer(7); _sage_const_104 = Integer(104); _sage_const_8 = Integer(8)## This file (propertiesOfLogs.sagetex.sage) was *autogenerated* from propertiesOfLogs.tex with sagetex.sty version 2015/08/26 v3.0-92d9f7a.
import sagetex
