...
_sage_const_54 = Integer(54); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_6 = Integer(6); _sage_const_4 = Integer(4); _sage_const_3 = Integer(3); _sage_const_0 = Integer(0); _sage_const_5 = Integer(5); _sage_const_210 = Integer(210); _sage_const_216 = Integer(216); _sage_const_218 = Integer(218); _sage_const_225 = Integer(225); _sage_const_227 = Integer(227); _sage_const_234 = Integer(234); _sage_const_7 = Integer(7); _sage_const_236 = Integer(236); _sage_const_8 = Integer(8); _sage_const_243 = Integer(243); _sage_const_9 = Integer(9); _sage_const_10 = Integer(10); _sage_const_245 = Integer(245); _sage_const_11 = Integer(11)## This file (determineObliqueAsymptotes.sagetex.sage) was *autogenerated* from determineObliqueAsymptotes.tex with sagetex.sty version 2019/11/14 v3.4.
import sagetex
_st_ = sagetex.SageTeXProcessor('determineObliqueAsymptotes', version='2019/11/14 v3.4', version_check=True)
