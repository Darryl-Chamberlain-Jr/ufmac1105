...
# This file was *autogenerated* from the file determineVerticalAsymptotes.sagetex.sage
from sage.all_cmdline import *   # import sage library

_sage_const_50 = Integer(50); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_6 = Integer(6); _sage_const_4 = Integer(4); _sage_const_7 = Integer(7); _sage_const_151 = Integer(151); _sage_const_157 = Integer(157); _sage_const_0 = Integer(0); _sage_const_167 = Integer(167); _sage_const_3 = Integer(3); _sage_const_169 = Integer(169); _sage_const_177 = Integer(177); _sage_const_5 = Integer(5); _sage_const_179 = Integer(179); _sage_const_8 = Integer(8); _sage_const_188 = Integer(188); _sage_const_9 = Integer(9); _sage_const_10 = Integer(10); _sage_const_190 = Integer(190); _sage_const_11 = Integer(11); _sage_const_12 = Integer(12); _sage_const_13 = Integer(13); _sage_const_198 = Integer(198); _sage_const_14 = Integer(14); _sage_const_15 = Integer(15); _sage_const_200 = Integer(200); _sage_const_16 = Integer(16); _sage_const_17 = Integer(17); _sage_const_208 = Integer(208); _sage_const_18 = Integer(18); _sage_const_19 = Integer(19)## This file (determineVerticalAsymptotes.sagetex.sage) was *autogenerated* from determineVerticalAsymptotes.tex with sagetex.sty version 2015/08/26 v3.0-92d9f7a.
import sagetex
...
try:
 ...
 _st_.inline(_sage_const_2 , latex(function2num))
except:
 _st_.goboom(_sage_const_167 )
try:
 _st_.current_tex_line = _sage_const_167 
 _st_.inline(_sage_const_3 , latex(function2denom))
except:
 _st_.goboom(_sage_const_167 )
try:
 _st_.current_tex_line = _sage_const_169 
 _st_.inline(_sage_const_4 , latex(answer2))
except:
...
try:
 ...
 _st_.inline(_sage_const_7 , latex(answer3a))
except:
 _st_.goboom(_sage_const_179 )
try:
 _st_.current_tex_line = _sage_const_179 
 _st_.inline(_sage_const_8 , latex(answer3b))
except:
 _st_.goboom(_sage_const_179 )
try:
 _st_.current_tex_line = _sage_const_188 
 _st_.inline(_sage_const_9 , latex(function4num))
except:
 _st_.goboom(_sage_const_188 )
try:
 _st_.current_tex_line = _sage_const_188 
 _st_.inline(_sage_const_10 , latex(function4denom))
except:
 _st_.goboom(_sage_const_188 )
try:
 _st_.current_tex_line = _sage_const_190 
 _st_.inline(_sage_const_11 , latex(answer4a))
except:
 _st_.goboom(_sage_const_190 )
try:
 _st_.current_tex_line = _sage_const_190 
 _st_.inline(_sage_const_12 , latex(answer4b))
except:
 _st_.goboom(_sage_const_190 )
try:
 _st_.current_tex_line = _sage_const_190 
 _st_.inline(_sage_const_13 , latex(answer4c))
except:
 _st_.goboom(_sage_const_190 )
try:
 _st_.current_tex_line = _sage_const_198 
 _st_.inline(_sage_const_14 , latex(function5num))
except:
 _st_.goboom(_sage_const_198 )
try:
 _st_.current_tex_line = _sage_const_198 
 _st_.inline(_sage_const_15 , latex(function5denom))
except:
 _st_.goboom(_sage_const_198 )
try:
 _st_.current_tex_line = _sage_const_200 
 _st_.inline(_sage_const_16 , latex(answer5b))
except:
 _st_.goboom(_sage_const_200 )
try:
 _st_.current_tex_line = _sage_const_200 
 _st_.inline(_sage_const_17 , latex(answer5c))
except:
 _st_.goboom(_sage_const_200 )
try:
 _st_.current_tex_line = _sage_const_208 
 _st_.inline(_sage_const_18 , latex(function6num))
except:
 _st_.goboom(_sage_const_208 )
try:
 _st_.current_tex_line = _sage_const_208 
 _st_.inline(_sage_const_19 , latex(function6denom))
except:
 _st_.goboom(_sage_const_208 )
_st_.endofdoc()
