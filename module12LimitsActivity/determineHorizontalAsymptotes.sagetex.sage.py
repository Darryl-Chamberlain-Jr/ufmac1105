...
_sage_const_99 = Integer(99); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_6 = Integer(6); _sage_const_4 = Integer(4); _sage_const_3 = Integer(3); _sage_const_0 = Integer(0); _sage_const_5 = Integer(5); _sage_const_255 = Integer(255); _sage_const_261 = Integer(261); _sage_const_263 = Integer(263); _sage_const_270 = Integer(270); _sage_const_279 = Integer(279); _sage_const_281 = Integer(281); _sage_const_7 = Integer(7); _sage_const_288 = Integer(288); _sage_const_8 = Integer(8); _sage_const_9 = Integer(9)## This file (determineHorizontalAsymptotes.sagetex.sage) was *autogenerated* from determineHorizontalAsymptotes.tex with sagetex.sty version 2019/11/14 v3.4.
import sagetex
_st_ = sagetex.SageTeXProcessor('determineHorizontalAsymptotes', version='2019/11/14 v3.4', version_check=True)
